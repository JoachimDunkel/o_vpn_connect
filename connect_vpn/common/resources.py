...
CONFIGURE_CONNECTION_FILE_NAME = 'configure_connection.yaml'
PATH_CREDENTIALS_FILE = PATH_CONFIG_DIR / CONFIGURE_CONNECTION_FILE_NAME
...
CONNECTION_HEARTBEAT_INTERVAL_SEC = 2
